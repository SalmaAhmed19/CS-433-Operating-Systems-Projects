...
private:
    ...
    int size;
    int num;//to keep count of PCB
   //Data structure used: vector

    vector<PCB*> processes_in;//vectors that have the processes in the system 
    //vector<int> pq_out; //any processes that is not in the piority queue
